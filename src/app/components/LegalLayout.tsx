    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-10">
          <article className="article prose prose-lg dark:prose-invert mx-auto max-w-3xl md:max-w-4xl prose-headings:font-bold prose-headings:tracking-tight prose-a:no-underline hover:prose-a:underline prose-a:decoration-2 prose-a:underline-offset-4">{children}</article>
          <aside>
            <TableOfContents />
          </aside>
        </div>
