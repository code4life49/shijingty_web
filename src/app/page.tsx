    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto">Building digital products with passion and precision</p>

          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <button className="bg-blue-600 hover:bg-blue-700 px-8 py-3 rounded-full transition-colors font-medium">View Our Work</button>
            <button className="border border-gray-600 hover:border-gray-400 px-8 py-3 rounded-full transition-colors">Contact Us</button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6">We are a lean, agile one-person company specializing in innovative web and mobile solutions. Our independent approach allows for rapid iteration, personalized service, and creative freedom.</p>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 italic">&ldquo;Building digital solutions with passion and precision&rdquo;</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-blue-500 transition-colors">
              ...
              <p className="text-gray-400">Modern, responsive websites and web applications using the latest technologies.</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-blue-500 transition-colors">
              <div className="text-blue-400 text-2xl mb-4">📱</div>
              <h4 className="text-xl font-semibold mb-3">Mobile Apps</h4>
              <p className="text-gray-400">Cross-platform mobile applications that deliver exceptional user experiences.</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-blue-500 transition-colors">
              <div className="text-blue-400 text-2xl mb-4">⚡</div>
              <h4 className="text-xl font-semibold mb-3">Consulting</h4>
              <p className="text-gray-400">Technical consulting and architecture design for your digital projects.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-16 px-6 bg-gray-900/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">Ready to bring your ideas to life? Get in touch and let&rsquo;s discuss how we can create something amazing together.</p>
          <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-8 py-3 rounded-full transition-all font-medium">Start a Project</button>
        </div>
      </section>
